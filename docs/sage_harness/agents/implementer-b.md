...
## runtime_bindings
- model / effort: (from profile.team.core.implementer-b.runtime; unset model = host CLI default,
  unset effort = high). claude host only — injected into .claude/agents/implementer-b.md frontmatter
