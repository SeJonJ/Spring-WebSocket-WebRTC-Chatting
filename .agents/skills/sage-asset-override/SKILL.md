...
> `docs/sage_harness/skills/sage-asset-override.md`. Codex reads this render from the
> repo (`.Codex/skills/sage-asset-override/`); Codex reads it from the user-global
...
- **Existing CORE roster id only.** kind(agent|skill|framework) + id must be one of:
  ...
  - framework: `AGENT_GUIDE`, `Codex`, `CODEX`, `AGENTS`
